...
public class Lote1_31_mod {

public static void main(String args[]) {

Double PRECOATUAL=0.0,VENDAMENSAL=0.0,NOVOPRECO=0.0;

processar(PRECOATUAL,VENDAMENSAL,NOVOPRECO);
}

static void processar(Double PRECOATUAL, Double VENDAMENSAL, Double NOVOPRECO)
{        
