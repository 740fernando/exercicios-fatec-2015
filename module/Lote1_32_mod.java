/*
        * Nome do programa: Lote1_32_mod(procedimento com retorno de parâmetros).
     ...
     Double POUPANCA,RENDAFIXA;   
        switch(x)
        {
            case 1: POUPANCA=Double.parseDouble(JOptionPane.showInputDialog("Digite o valor de depósito na poupança"));
                    while (POUPANCA<0){
                        POUPANCA=Double.parseDouble(JOptionPane.showInputDialog("Digite o valor de depósito na poupança"));    
                    }
            ...
            case 2: RENDAFIXA=Double.parseDouble(JOptionPane.showInputDialog("Digite o valor de depósito na Renda Fixa"));
                    while (RENDAFIXA<0){
                        RENDAFIXA=Double.parseDouble(JOptionPane.showInputDialog("Digite o valor de depósito na Renda Fixa"));
                    }
